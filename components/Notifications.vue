<template>
  <div className="relative inline-flex">
      <button
        ref={trigger}
        className="w-8 h-8 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700 dark:lg:hover:bg-gray-800 rounded-full"
        aria-haspopup="true"
      >
      ...
      <Transition
        className="origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1" 
        show={dropdownOpen}
